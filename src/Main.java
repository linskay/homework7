public class Main {
    public static void main(String[] args) {
        ...
        double birthRatePercent = 0.017;
        for (int i = 1; i <= 10; i++) {
            int population = (int) ((birthRatePercent - deathPercent) * countryYPopulation);
            countryYPopulation += population;
            System.out.println("Год " + i + ", численность население составляет " + countryYPopulation);
        }
        System.out.println("Task 4");
        int depositVasiliy = 15000;
        int totalVasiliy = 0;
        for (int mounthVasya = 1; totalVasiliy < 12_000_000; mounthVasya++) {
            totalVasiliy += totalVasiliy * 0.07;
        ...
        for (int mounthVasyaTask5 = 1; totalVasiliyTask5 < 12_000_000; mounthVasyaTask5++) {
            totalVasiliyTask5 += totalVasiliyTask5 * 0.07;
            totalVasiliyTask5 = depositVasiliy + totalVasiliyTask5;
        ...
        for (int mounthVasyaTask6 = 1; mounthVasyaTask6 <= 9 * 12; mounthVasyaTask6++) {
            totalVasiliyTask6 += totalVasiliyTask6 * 0.07;
            totalVasiliyTask6 = depositVasiliy + totalVasiliyTask6;
